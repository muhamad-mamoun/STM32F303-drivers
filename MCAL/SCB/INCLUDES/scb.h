...
Description  : Interface file for the STM32 System Control Block driver.
=======================================================================================================================
*/
...
typedef enum
{
    SCB_NO_ERRORS,
    SCB_NULL_PTR_ERROR,
    SCB_PRIORITY_LEVEL_ERROR,
}SCB_errorStatusType;

typedef enum
{
    SCB_PRIGROUP_LEVEL_A = 0X00, /* 4-bit for Group [7:4],  and 0-bit for Subgroup [None]. */
    SCB_PRIGROUP_LEVEL_B = 0X04, /* 3-bit for group [7:5],  and 1-bit for Subgroup [4].    */
    SCB_PRIGROUP_LEVEL_C = 0X05, /* 2-bit for group [7:6],  and 2-bit for Subgroup [5:4].  */
    SCB_PRIGROUP_LEVEL_D = 0X06, /* 1-bit for group [7],    and 3-bit for Subgroup [6:4].  */
    SCB_PRIGROUP_LEVEL_E = 0X07, /* 0-bit for group [None], and 4-bit for Subgroup [7:4].  */
